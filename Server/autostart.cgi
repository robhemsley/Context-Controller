...
try:
    ...
    pid = open('/home/robhemsley/webapps/captions/pid').read()
    ...
    if len(lines) > 1:
        ...
        # Delete pid file
        os.remove('/home/robhemsley/webapps/captions/pid')
except IOError:
    pass
...
if running:
    ...
    pid = os.fork()
    if pid == 0:
        os.execl('/usr/local/bin/python2.6', '/usr/local/bin/python2.6', '/home/robhemsley/webapps/captions/site.py')
    else:
        open('/home/robhemsley/webapps/captions/pid', 'w').write(str(pid))
